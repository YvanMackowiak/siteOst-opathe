  ...
  return (
    <div>
      ...
      <p>
        ...
        est précisé aux utilisateurs du site{" "}
        <a href="http://http://www.balma-osteopathe.fr//">http://www.balma-osteopathe.fr/</a> l'identité des différents
        intervenants dans le cadre de sa réalisation et de son suivi :
      </p>
      <p>
        <strong>Propriétaire</strong> : Nicolaïeff – 85144177400011 – 30 rue d'assalit toulouse
        <br />
        <strong>Créateur</strong> : <a href="http://www.balma-osteopathe.fr/">Mackowiak</a>
        <br />
        <strong>Responsable publication</strong> : Mackowiak – yvanmackowiak@gmail.com
        <br />
        Le responsable publication est une personne physique ou une personne morale.
        <br />
        <strong>Webmaster</strong> : Mackowiak – yvanmackowiak@gmail.com
        <br />
        <strong>Hébergeur</strong> : infomaniak – Rue Eugène-Marziano 25, 1227 Genève, Suisse
        <br />
        Crédits : <br />
        Le modèle de mentions légales est offert par Subdelirium.com{" "}
        <a target="_blank" href="https://www.subdelirium.com/generateur-de-mentions-legales/">
          Mentions légales
        </a>
      </p>
      ...
      <p>
        L’utilisation du site <a href="http://http://www.balma-osteopathe.fr//">http://www.balma-osteopathe.fr/</a>{" "}
        ...
        site <a href="http://http://www.balma-osteopathe.fr//">http://www.balma-osteopathe.fr/</a> sont donc invités à
      ...
      <p>
        ...
        technique peut être toutefois décidée par Nicolaïeff, qui s’efforcera alors de communiquer préalablement aux
        utilisateurs les dates et heures de l’intervention.
      </p>
      <p>
        Le site <a href="http://http://www.balma-osteopathe.fr//">http://www.balma-osteopathe.fr/</a> est mis à jour
        régulièrement par Mackowiak. De la même façon, les mentions légales peuvent être modifiées à tout moment : elles
        s’imposent néanmoins à l’utilisateur qui est invité à s’y référer le plus souvent possible afin d’en prendre
        connaissance.
      </p>
      <h3>3. Description des services fournis.</h3>
      <p>
        Le site <a href="http://http://www.balma-osteopathe.fr//">http://www.balma-osteopathe.fr/</a> a pour objet de
        fournir une information concernant l’ensemble des activités de la société.
      </p>
      <p>
        Nicolaïeff s’efforce de fournir sur le site{" "}
        <a href="http://http://www.balma-osteopathe.fr//">http://www.balma-osteopathe.fr/</a> des informations aussi
        précises que possible. Toutefois, il ne pourra être tenue responsable des omissions, des inexactitudes et des
        carences dans la mise à jour, qu’elles soient de son fait ou du fait des tiers partenaires qui lui fournissent
        ces informations.
      </p>
      <p>
        Tous les informations indiquées sur le site{" "}
        <a href="http://http://www.balma-osteopathe.fr//">http://www.balma-osteopathe.fr/</a> sont données à titre
        indicatif, et sont susceptibles d’évoluer. Par ailleurs, les renseignements figurant sur le site{" "}
        <a href="http://http://www.balma-osteopathe.fr//">http://www.balma-osteopathe.fr/</a> ne sont pas exhaustifs.
      ...
      <p>
        Nicolaïeff est propriétaire des droits de propriété intellectuelle ou détient les droits d’usage sur tous les
      ...
      <p>
        Nicolaïeff ne pourra être tenue responsable des dommages directs et indirects causés au matériel de
        l’utilisateur, lors de l’accès au site http://www.balma-osteopathe.fr/, et résultant soit de l’utilisation d’un
        matériel ne répondant pas aux spécifications indiquées au point 4, soit de l’apparition d’un bug ou d’une
        incompatibilité.
      </p>
      <p>
        Nicolaïeff ne pourra également être tenue responsable des dommages indirects (tels par exemple qu’une perte de
        marché ou perte d’une chance) consécutifs à l’utilisation du site{" "}
        <a href="http://http://www.balma-osteopathe.fr//">http://www.balma-osteopathe.fr/</a>.
      </p>
      <p>
        Des espaces interactifs (possibilité de poser des questions dans l’espace contact) sont à la disposition des
        utilisateurs. Nicolaïeff se réserve le droit de supprimer, sans mise en demeure préalable, tout contenu déposé
        dans cet espace qui contreviendrait à la législation applicable en France, en particulier aux dispositions
        relatives à la protection des données. Le cas échéant, Nicolaïeff se réserve également la possibilité de mettre
      ...
      <p>
        ...
        2004-801 du 6 août 2004, l'article L. 226-13 du Code pénal et la Directive Européenne du 24 octobre 1995.
      </p>
      <p>
        A l'occasion de l'utilisation du site{" "}
        <a href="http://http://www.balma-osteopathe.fr//">http://www.balma-osteopathe.fr/</a>, peuvent êtres recueillies
        : l'URL des liens par l'intermédiaire desquels l'utilisateur a accédé au site{" "}
        <a href="http://http://www.balma-osteopathe.fr//">http://www.balma-osteopathe.fr/</a>, le fournisseur d'accès de
        l'utilisateur, l'adresse de protocole Internet (IP) de l'utilisateur.
      </p>
      <p>
        {" "}
        En tout état de cause Nicolaïeff ne collecte des informations personnelles relatives à l'utilisateur que pour le
        besoin de certains services proposés par le site{" "}
        <a href="http://http://www.balma-osteopathe.fr//">http://www.balma-osteopathe.fr/</a>. L'utilisateur fournit ces
        ...
        <a href="http://http://www.balma-osteopathe.fr//">http://www.balma-osteopathe.fr/</a> l’obligation ou non de
      ...
      <p>
        ...
        d’opposition aux données personnelles le concernant, en effectuant sa demande écrite et signée, accompagnée
        d’une copie du titre d’identité avec signature du titulaire de la pièce, en précisant l’adresse à laquelle la
        réponse doit être envoyée.
      </p>
      <p>
        Aucune information personnelle de l'utilisateur du site{" "}
        <a href="http://http://www.balma-osteopathe.fr//">http://www.balma-osteopathe.fr/</a> n'est publiée à l'insu de
        l'utilisateur, échangée, transférée, cédée ou vendue sur un support quelconque à des tiers. Seule l'hypothèse du
        rachat de Nicolaïeff et de ses droits permettrait la transmission des dites informations à l'éventuel acquéreur
        qui serait à son tour tenu de la même obligation de conservation et de modification des données vis à vis de
        l'utilisateur du site <a href="http://http://www.balma-osteopathe.fr//">http://www.balma-osteopathe.fr/</a>.
      </p>
      <p>
      ...
      <p>
        Le site <a href="http://http://www.balma-osteopathe.fr//">http://www.balma-osteopathe.fr/</a> contient un
        certain nombre de liens hypertextes vers d’autres sites, mis en place avec l’autorisation de Nicolaïeff.
        Cependant, Nicolaïeff n’a pas la possibilité de vérifier le contenu des sites ainsi visités, et n’assumera en
        conséquence aucune responsabilité de ce fait.
      </p>
      <p>
        La navigation sur le site <a href="http://http://www.balma-osteopathe.fr//">http://www.balma-osteopathe.fr/</a>{" "}
        est susceptible de provoquer l’installation de cookie(s) sur l’ordinateur de l’utilisateur. Un cookie est un
      ...
      <p>
        ...
        <a href="http://http://www.balma-osteopathe.fr//">http://www.balma-osteopathe.fr/</a> est soumis au droit
      ...
      <p>
        Informations personnelles : « les informations qui permettent, sous quelque forme que ce soit, directement ou
